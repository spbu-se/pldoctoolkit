...
public class DrlModelLoadResourceAction implements IObjectActionDelegate {
	 ...
	 * @generated
	 */
	private FinalInfProductEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof FinalInfProductEditPart) {
				mySelectedElement = (FinalInfProductEditPart) structuredSelection
						.getFirstElement();
			}
		}
