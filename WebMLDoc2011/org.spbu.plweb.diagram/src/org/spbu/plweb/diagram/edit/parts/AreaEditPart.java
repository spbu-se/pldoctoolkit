...
import org.spbu.plweb.diagram.edit.policies.AreaCanonicalEditPolicy;
import org.spbu.plweb.diagram.edit.policies.AreaItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AreaEditPart extends TargetRefElementEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AreaTitleEditPart) {
			((AreaTitleEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureAreaTitleFigure());
			return true;
		}
		return false;
	}
	...
	public class AreaFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureAreaTitleFigure;
		...
		private void createContents() {
			...
			fFigureAreaTitleFigure = new WrappingLabel();
			fFigureAreaTitleFigure.setText("<...>");

			this.add(fFigureAreaTitleFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAreaTitleFigure() {
			return fFigureAreaTitleFigure;
		}
