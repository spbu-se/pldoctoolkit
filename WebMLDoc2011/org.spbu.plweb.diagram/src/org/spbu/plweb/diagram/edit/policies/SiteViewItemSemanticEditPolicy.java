 ...
 * @generated
 */
public class SiteViewItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PlwebElementTypes.DocTopic_3006 == req.getElementType()) {
			return getGEFWrapper(new DocTopic2CreateCommand(req));
		}
