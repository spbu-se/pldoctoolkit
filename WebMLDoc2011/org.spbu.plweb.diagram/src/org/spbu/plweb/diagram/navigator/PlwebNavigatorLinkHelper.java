...
public class PlwebNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = PlwebDiagramEditorPlugin.getInstance()
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		PlwebAbstractNavigatorItem abstractNavigatorItem = (PlwebAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof PlwebNavigatorItem) {
			navigatorView = ((PlwebNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof PlwebNavigatorItem) {
				navigatorView = ((PlwebNavigatorItem) navigatorGroup
						.getParent()).getView();
			}
		}
