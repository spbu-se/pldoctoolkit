 ...
 * @generated
 */
public class PlwebDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public PlwebDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof PlwebDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((PlwebDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new PlwebDomainNavigatorItem((EObject) objects[i],
