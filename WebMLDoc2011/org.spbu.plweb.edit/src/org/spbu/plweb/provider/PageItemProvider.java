...
/**
 * This is the item provider adapter for a {@link org.spbu.plweb.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Page_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Page_source_feature", "_UI_Page_type"),
				 PlwebPackage.Literals.PAGE__SOURCE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Page.class)) {
			case PlwebPackage.PAGE__SOURCE:
