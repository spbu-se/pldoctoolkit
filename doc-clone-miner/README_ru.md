...
* PyQt, PyQtWebEngine, QuaMash, LXML, PyContracts, pygments, NumPy, intervaltree, bottle, pyinterval, pypandoc, chardet, psutil, PyYAML — `pip install -r 2requirements.txt`
* Опционально:
