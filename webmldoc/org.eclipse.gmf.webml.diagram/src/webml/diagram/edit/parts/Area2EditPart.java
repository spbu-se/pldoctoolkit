...
public class Area2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AreaAreaTopicCompartment2EditPart) {
			...
			pane.add(((AreaAreaTopicCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof AreaAreaElementCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AreaAreaElementCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AreaAreaTopicCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAreaTopicCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((AreaAreaTopicCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof AreaAreaElementCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAreaElementCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((AreaAreaElementCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
