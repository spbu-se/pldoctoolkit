 ...
 * @generated
 */
public class WebmlMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = WebmlDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			WebmlDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
