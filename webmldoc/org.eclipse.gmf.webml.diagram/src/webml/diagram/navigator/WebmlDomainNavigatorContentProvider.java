 ...
 * @generated
 */
public class WebmlDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public WebmlDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof WebmlDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((WebmlDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new WebmlDomainNavigatorItem((EObject) objects[i],
