 ...
 * @generated
 */
public class DrlModelStructuralFeatureParser extends DrlModelAbstractParser {
	 ...
	 * @generated
	 */
	public DrlModelStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(DrlModelDiagramEditorPlugin.ID,
