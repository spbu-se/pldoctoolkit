 ...
 * @generated
 */
public class DrlModelDiagramEditorUtil extends IDEEditorUtil {
	...
	public static final IFile createAndOpenDiagram(
		...
		IFile diagramFile = DrlModelDiagramEditorUtil.createNewDiagramFile(
	...
	public static final IFile createNewDiagramFile(
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				DocumentationCore model = createInitialModel();
	 ...
	 * @generated
	 */
	private static DocumentationCore createInitialModel() {
		return DrlFactory.eINSTANCE.createDocumentationCore();
	}

	/**
	 * @generated
	 */
	private static EObject createInitialRoot(DocumentationCore model) {
		return model;
	}
}
