...
import org.spbu.pldoctoolkit.drlvisual.util.drlResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>drlvisual</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class drlExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.drl"));
				InfElement root = drlFactory.eINSTANCE.createInfElement();
