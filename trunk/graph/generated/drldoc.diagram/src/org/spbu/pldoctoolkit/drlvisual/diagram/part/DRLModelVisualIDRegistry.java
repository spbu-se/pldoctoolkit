...
public class DRLModelVisualIDRegistry {
	...
	private static int getDiagramVisualID(EObject domainElement,
		...
		if (drlPackage.eINSTANCE.getSchema().isSuperTypeOf(
				domainElementMetaclass)
				&& isDiagramSchema_79((Schema) domainElement)) {
			return SchemaEditPart.VISUAL_ID;
		}
	...
	public static int getNodeVisualID(View containerView,
		...
		case InfElementEditPart.VISUAL_ID:
			if (InfElementNameIdEditPart.VISUAL_ID == nodeVisualID) {
				return InfElementNameIdEditPart.VISUAL_ID;
			}
			return getUnrecognizedInfElement_1001ChildNodeID(domainElement,
					semanticHint);
		case InfProductEditPart.VISUAL_ID:
			if (InfProductNameIdEditPart.VISUAL_ID == nodeVisualID) {
				return InfProductNameIdEditPart.VISUAL_ID;
			}
			return getUnrecognizedInfProduct_1002ChildNodeID(domainElement,
					semanticHint);
		case InfElemRefGroupEditPart.VISUAL_ID:
			if (InfElemRefGroupNameEditPart.VISUAL_ID == nodeVisualID) {
				return InfElemRefGroupNameEditPart.VISUAL_ID;
			}
		...
		case SchemaEditPart.VISUAL_ID:
			...
			return getUnrecognizedSchema_79ChildNodeID(domainElement,
					semanticHint);
		...
		case InfElemRef2EditPart.VISUAL_ID:
			...
			return getUnrecognizedInfElemRef_3002LinkLabelID(semanticHint);
		}
		return -1;
	}
	...
	public static int getLinkWithClassVisualID(EObject domainElement,
		...
		if (drlPackage.eINSTANCE.getInfElemRef().isSuperTypeOf(
			...
			return InfElemRefEditPart.VISUAL_ID;
				...
				domainElementMetaclass)
				&& (domainElement == null || isLinkWithClassInfElemRef_3002((InfElemRef) domainElement))) {
	 ...
	 * @generated
	 */
	private static boolean isDiagramSchema_79(Schema element) {
		return true;
	}
	 ...
	 * @generated
	 */
	private static int getUnrecognizedSchema_79ChildNodeID(
			EObject domainElement, String semanticHint) {
		return -1;
	}
	 ...
	 * @generated
	 */
	private static int getUnrecognizedInfElemRef_3002LinkLabelID(
			String semanticHint) {
		return -1;
	}
	 ...
	 * @generated
	 */
	private static boolean isLinkWithClassInfElemRef_3002(InfElemRef element) {
		return InfElemRef_3002.matches(element);
	}
	 ...
	 * @generated
	 */
	private static final Matcher InfElemRef_3002 = new Matcher(
			DRLModelOCLFactory.getExpression("self.optional = false", //$NON-NLS-1$
					drlPackage.eINSTANCE.getInfElemRef()));
