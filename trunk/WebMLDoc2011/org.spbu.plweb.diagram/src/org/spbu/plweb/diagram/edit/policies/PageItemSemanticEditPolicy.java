 ...
 * @generated
 */
public class PageItemSemanticEditPolicy extends PlwebBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PlwebElementTypes.DocTopic_3008 == req.getElementType()) {
			return getGEFWrapper(new DocTopic4CreateCommand(req));
		}
