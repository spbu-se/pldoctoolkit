 ...
 * @generated
 */
public class PlwebViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = PlwebVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = PlwebVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!PlwebElementTypes.isKnownElementType(elementType)
				...
				case DocTopic5EditPart.VISUAL_ID:
					if (domainElement == null
							|| visualID != PlwebVisualIDRegistry
		...
		return RootEditPart.VISUAL_ID == visualID
				|| SiteViewEditPart.VISUAL_ID == visualID
				...
				|| DocTopic2EditPart.VISUAL_ID == visualID
				|| DocTopic3EditPart.VISUAL_ID == visualID
				|| DocTopic4EditPart.VISUAL_ID == visualID
				|| DocTopic5EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = PlwebVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != PlwebVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = PlwebVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = PlwebVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case RootEditPart.VISUAL_ID:
			return createRoot_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case SiteViewEditPart.VISUAL_ID:
			return createSiteView_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case AreaEditPart.VISUAL_ID:
			return createArea_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case PageEditPart.VISUAL_ID:
		...
		case NodeEditPart.VISUAL_ID:
			return createNode_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case DocTopicEditPart.VISUAL_ID:
			return createDocTopic_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		case DocTopic2EditPart.VISUAL_ID:
			return createDocTopic_3006(domainElement, containerView, index,
					persisted, preferencesHint);
		case DocTopic3EditPart.VISUAL_ID:
			return createDocTopic_3007(domainElement, containerView, index,
					persisted, preferencesHint);
		case DocTopic4EditPart.VISUAL_ID:
			return createDocTopic_3008(domainElement, containerView, index,
					persisted, preferencesHint);
		case DocTopic5EditPart.VISUAL_ID:
			return createDocTopic_3009(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (PlwebVisualIDRegistry.getVisualID(elementTypeHint)) {
		case SourceRefElementClassEditPart.VISUAL_ID:
			return createSourceRefElementClass_4001(containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createRoot_2001(EObject domainElement, View containerView,
		...
		node.setType(PlwebVisualIDRegistry.getType(RootEditPart.VISUAL_ID));
		...
		createCompartment(node,
				PlwebVisualIDRegistry
						.getType(RootTopicRootCompartmentEditPart.VISUAL_ID),
	 ...
	 * @generated
	 */
	public Node createSiteView_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(SiteViewEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		createCompartment(
				node,
				PlwebVisualIDRegistry
						.getType(SiteViewTopicSiteViewCompartmentEditPart.VISUAL_ID),
				true, false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createArea_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(AreaEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		createCompartment(node,
				PlwebVisualIDRegistry
						.getType(AreaTopicAreaCompartmentEditPart.VISUAL_ID),
				true, false, true, true);
		return node;
	}
	...
	public Node createPage_2004(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(PageEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		createCompartment(node,
				PlwebVisualIDRegistry
						.getType(PageTopicPageCompartmentEditPart.VISUAL_ID),
				true, false, true, true);
		return node;
	}
	...
	public Node createGroup_2005(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(GroupEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createNode_2006(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(NodeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		createCompartment(node,
				PlwebVisualIDRegistry
						.getType(NodeTopicNodeCompartmentEditPart.VISUAL_ID),
				true, false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createDocTopic_3005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(DocTopicEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createDocTopic_3006(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(DocTopic2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createDocTopic_3007(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(DocTopic3EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createDocTopic_3008(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(DocTopic4EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createDocTopic_3009(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(DocTopic5EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createSourceRefElementClass_4001(View containerView, int index,
		...
		edge.setType(PlwebVisualIDRegistry
