...
public class Group extends GroupsAware implements TypeAware {
	...
	public Group(final boolean optional, final String title, final List<Page> pages,
			final List<SiteView> siteViews, final List<Area> areas,
			final List<Node> nodes, final List<Group> groups,
			final List<DocTopic> topics, final boolean groupXOR) {
