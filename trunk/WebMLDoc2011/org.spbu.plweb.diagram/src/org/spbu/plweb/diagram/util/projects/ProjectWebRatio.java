...
import org.spbu.plweb.diagram.util.PageLinkInfo;
import org.spbu.plweb.diagram.util.parsers.PageLinksParser;
...
public class ProjectWebRatio extends ProjectAbstract {
	...
	public Root getProjectParts() {
		return PartsReader.readParts(path);
	}
