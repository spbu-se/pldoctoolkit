...
public class RegisteredLocation {
	...
	public static final String NEST_POINT   = "Nest";
	public static final String INF_ELEM_REF_GROUP = "InfElemRefGroup";
	...
	public RegisteredLocation(String context, String type, String id, String name, File file, int lineNumber) {
