...
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.CORE_CONTEXT;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.DICTIONARY;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.DIRECTORY;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.DIRTEMPLATE;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.FINAL_INF_PRODUCT;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.INF_ELEMENT;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.INF_ELEM_REF;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.INF_ELEM_REF_GROUP;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.INF_PRODUCT;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.NEST_POINT;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.PRODUCT;
import static org.spbu.pldoctoolkit.exportutil.utils.RegisteredLocation.PRODUCT_CONTEXT;
...
public class ProjectRegistryImpl implements ProjectRegistry {
	...
	private void registerFile(File file) throws ExportExeption {
		for (String key: locationMap.keySet()) {
			File fileInMap = locationMap.get(key).getFile();
			if (file.equals(fileInMap))
		...
		if (ext != "" && ext.toLowerCase().equals(ExportUtil.DRL_FILE_EXTENSION)) {
			try {
				...
				throw new ExportExeption("Parser Configuration Error: " + e.getMessage());
