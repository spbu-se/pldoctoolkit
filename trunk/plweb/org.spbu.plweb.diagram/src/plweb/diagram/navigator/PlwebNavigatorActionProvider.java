...
import plweb.diagram.part.PlwebDiagramEditor;
 ...
 * @generated
 */
public class PlwebNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof PlwebNavigatorItem) {
					selectedElement = ((PlwebNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (DiagramRootEditPart.MODEL_ID
							.equals(PlwebVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, PlwebDiagramEditor.ID);
