...
public class PlwebViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = PlwebVisualIDRegistry.getNodeVisualID(op
	...
	public Node createArea_2001(EObject domainElement, View containerView,
		...
		Node label5001 = createLabel(node, PlwebVisualIDRegistry
	...
	public Node createPage_2003(EObject domainElement, View containerView,
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5003 = createLabel(node, PlwebVisualIDRegistry
	...
	public Node createClass_2004(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(PlwebVisualIDRegistry.getType(ClassEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5004 = createLabel(node, PlwebVisualIDRegistry
				.getType(ClassTitleEditPart.VISUAL_ID));
		return node;
	}
