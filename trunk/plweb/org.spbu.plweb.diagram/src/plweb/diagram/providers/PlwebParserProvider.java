...
public class PlwebParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser classTitle_5004Parser;

	/**
	 * @generated
	 */
	private IParser getClassTitle_5004Parser() {
		if (classTitle_5004Parser == null) {
			EAttribute[] features = new EAttribute[] { PlwebPackage.eINSTANCE
					.getElement_Title() };
			MessageFormatParser parser = new MessageFormatParser(features);
			classTitle_5004Parser = parser;
		}
		return classTitle_5004Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case ClassTitleEditPart.VISUAL_ID:
			return getClassTitle_5004Parser();
		}
		return null;
	}
