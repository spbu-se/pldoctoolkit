...
import plweb.diagram.part.PlwebDiagramUpdater;
import plweb.diagram.part.PlwebLinkDescriptor;
import plweb.diagram.part.PlwebNodeDescriptor;
...
public class DiagramRootCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = PlwebDiagramUpdater
				.getDiagramRoot_1000SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
			result.add(((PlwebNodeDescriptor) it.next()).getModelElement());
		}
		return result;
	}
	...
	protected boolean isOrphaned(Collection semanticChildren, final View view) {
		int visualID = PlwebVisualIDRegistry.getVisualID(view);
		switch (visualID) {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(PlwebPackage.eINSTANCE
					.getDiagramRoot_Area());
		}
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			int diagramLinkVisualID = PlwebVisualIDRegistry
			...
			for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
					.hasNext();) {
				PlwebLinkDescriptor nextLinkDescriptor = (PlwebLinkDescriptor) linkDescriptorsIterator
						.next();
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case DiagramRootEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PlwebDiagramUpdater
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final PlwebLinkDescriptor nextLinkDescriptor = (PlwebLinkDescriptor) linkDescriptorsIterator
					.next();
