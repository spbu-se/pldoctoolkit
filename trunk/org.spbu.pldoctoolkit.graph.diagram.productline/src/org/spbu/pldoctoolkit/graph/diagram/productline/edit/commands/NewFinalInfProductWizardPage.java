...
public class NewFinalInfProductWizardPage extends WizardPage {
	...
	private String type = PRODUCT_DOCUMENTATION;
	
	private Text containerText;
	private Text nameText;
	
	public NewFinalInfProductWizardPage(String pageName, String title, ImageDescriptor titleImage, IStructuredSelection selection) {
		super(pageName, title, titleImage);
		this.selection = selection;
	}

	public NewFinalInfProductWizardPage(String pageName, IStructuredSelection selection) {
		super(pageName);
		this.selection = selection;
	}
