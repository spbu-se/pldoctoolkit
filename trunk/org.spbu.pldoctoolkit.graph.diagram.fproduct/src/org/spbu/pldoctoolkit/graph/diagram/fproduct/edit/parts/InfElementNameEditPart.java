...
import org.spbu.pldoctoolkit.graph.diagram.fproduct.edit.policies.DrlModelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class InfElementNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InfElementNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new DrlModelParserProvider.HintAdapter(
					DrlModelElementTypes.InfElement_1002, getParserElement(),
					parserHint);
