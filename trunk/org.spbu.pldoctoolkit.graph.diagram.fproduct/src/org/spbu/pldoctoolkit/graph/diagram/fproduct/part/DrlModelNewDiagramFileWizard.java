...
public class DrlModelNewDiagramFileWizard extends Wizard {
	...
	public DrlModelNewDiagramFileWizard(URI domainModelURI,
		...
		myFileCreationPage.setFileName(DrlModelDiagramEditorUtil
				.getUniqueFileName(filePath, fileName, "fproduct_diagram")); //$NON-NLS-1$
	...
	public boolean performFinish() {
		...
		DrlModelDiagramEditorUtil.setCharset(diagramFile);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				myEditingDomain,
				Messages.DrlModelNewDiagramFileWizard_InitDiagramCommand,
				affectedFiles) {
			...
			protected CommandResult doExecuteWithResult(
				...
				int diagramVID = DrlModelVisualIDRegistry
						.getDiagramVisualID(diagramRootElementSelectionPage
								.getModelElement());
				if (diagramVID != FinalInfProductEditPart.VISUAL_ID) {
					return CommandResult
							.newErrorCommandResult(Messages.DrlModelNewDiagramFileWizard_IncorrectRootError);
				}
		...
		try {
			...
			diagramResource.save(DrlModelDiagramEditorUtil.getSaveOptions());
