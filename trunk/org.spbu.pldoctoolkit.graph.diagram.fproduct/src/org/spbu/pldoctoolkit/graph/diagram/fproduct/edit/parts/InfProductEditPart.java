...
import org.spbu.pldoctoolkit.graph.diagram.fproduct.edit.policies.InfProductItemSemanticEditPolicy;
...
public class InfProductEditPart extends ShapeNodeEditPart {
	...
	public class InfProductFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureInfProductNameFigure;
		...
		private void createContents() {
			...
			fFigureInfProductNameFigure = new WrapLabel();
			fFigureInfProductNameFigure.setText("<...>");

			this.add(fFigureInfProductNameFigure);
		...
		public WrapLabel getFigureInfProductNameFigure() {
			return fFigureInfProductNameFigure;
		}
