...
import org.spbu.pldoctoolkit.refactor.MakeRefRequired;
import org.spbu.pldoctoolkit.refactor.PositionInText;
import org.spbu.pldoctoolkit.refactor.ProjectContent;
import org.spbu.pldoctoolkit.registry.ProjectRegistryImpl;

public class MakeRefRequiredAction extends Action implements IValidateDRLSelection{
	IEditorPart editor;
	TextEditor te;
	IProject project;
	
	MakeRefRequired refact = new MakeRefRequired();
	ProjectContent projectContent;
	FileEditorInput editorInput;
	
	public static String refactName = "Make Ref Required"; 
	
	public MakeRefRequiredAction(IEditorPart editor) throws Exception {
		super(refactName);
		this.editor = editor;
