...
public class DrlOpenElementFileAction implements IObjectActionDelegate {
	...
	private static final Set<Class<? extends GraphicalEditPart>> ALLOWED_EDIT_PARTS = 
		new HashSet<Class<? extends GraphicalEditPart>>();
	
	static {
		ALLOWED_EDIT_PARTS.add(InfProductEditPart.class);
		ALLOWED_EDIT_PARTS.add(InfElementEditPart.class);
		ALLOWED_EDIT_PARTS.add(DocumentationCoreEditPart.class);
	}
