...
import webml.diagram.edit.policies.OperationUnit2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OperationUnit2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public OperationUnit2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OperationUnit2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationUnitName2EditPart) {
			((OperationUnitName2EditPart) childEditPart)
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof webml.diagram.edit.parts.OperationUnit2EditPart) {
			types.add(WebmlElementTypes.OkLink_4001);
		}
		if (targetEditPart instanceof AreaEditPart) {
			types.add(WebmlElementTypes.KoLink_4002);
