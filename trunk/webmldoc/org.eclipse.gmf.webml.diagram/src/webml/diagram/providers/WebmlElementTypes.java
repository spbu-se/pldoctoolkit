...
public class WebmlElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType Area_3005 = getElementType("org.eclipse.gmf.webml.diagram.Area_3005"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Area_3005, WebmlPackage.eINSTANCE.getArea());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Area_3005);
