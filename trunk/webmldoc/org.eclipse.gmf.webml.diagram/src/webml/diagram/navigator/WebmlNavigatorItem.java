	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof webml.diagram.navigator.WebmlNavigatorItem
						&& (adapterType == View.class || adapterType == EObject.class)) {
					return ((webml.diagram.navigator.WebmlNavigatorItem) adaptableObject)
							.getView();
				}
				return null;
			}
	...
	public boolean equals(Object obj) {
		if (obj instanceof webml.diagram.navigator.WebmlNavigatorItem) {
			return EcoreUtil
					...
					.equals(
							EcoreUtil
									.getURI(((webml.diagram.navigator.WebmlNavigatorItem) obj)
											.getView()));
		}
