...
import webml.diagram.part.WebmlDiagramEditor;
 ...
 * @generated
 */
public class WebmlNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof WebmlNavigatorItem) {
					selectedElement = ((WebmlNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, WebmlDiagramEditor.ID);
