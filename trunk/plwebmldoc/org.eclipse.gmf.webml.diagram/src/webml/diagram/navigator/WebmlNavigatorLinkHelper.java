 ...
 * @generated
 */
public class WebmlNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = WebmlDiagramEditorPlugin.getInstance()
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		WebmlAbstractNavigatorItem abstractNavigatorItem = (WebmlAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof WebmlNavigatorItem) {
			navigatorView = ((WebmlNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof WebmlNavigatorItem) {
				navigatorView = ((WebmlNavigatorItem) navigatorGroup
						.getParent()).getView();
