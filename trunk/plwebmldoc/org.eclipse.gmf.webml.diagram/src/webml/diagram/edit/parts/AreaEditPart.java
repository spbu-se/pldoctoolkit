...
import webml.diagram.edit.policies.AreaItemSemanticEditPolicy;
...
public class AreaEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AreaNameEditPart) {
			((AreaNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureAreaLabelFigure());
			return true;
		}
		if (childEditPart instanceof AreaAreaTopicCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getAreaTopicCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AreaAreaTopicCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof AreaAreaElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getAreaElementCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AreaAreaElementCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AreaAreaTopicCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getAreaTopicCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((AreaAreaTopicCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof AreaAreaElementCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getAreaElementCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((AreaAreaElementCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AreaAreaTopicCompartmentEditPart) {
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (targetEditPart instanceof webml.diagram.edit.parts.AreaEditPart) {
			types.add(WebmlElementTypes.NormalLink_4003);
		}
	...
	public class AreaFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureAreaLabelFigure.setMaximumSize(new Dimension(getMapMode()
