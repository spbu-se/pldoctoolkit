 ...
 * @generated
 */
public class TransportLinkReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TransportLinkReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof webml.transportLink) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return WebmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistTransportLink_4004(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Siteview container = (Siteview) getLink().eContainer();
		return WebmlBaseItemSemanticEditPolicy.LinkConstraints
				.canExistTransportLink_4004(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected webml.transportLink getLink() {
		return (webml.transportLink) getElementToEdit();
	}
