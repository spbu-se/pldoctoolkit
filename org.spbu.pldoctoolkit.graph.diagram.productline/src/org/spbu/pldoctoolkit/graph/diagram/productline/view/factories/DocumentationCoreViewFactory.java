 ...
 * @generated
 */
public class DocumentationCoreViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = DrlModelVisualIDRegistry
					.getType(DocumentationCoreEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						DrlModelVisualIDRegistry
								.getType(DocumentationCoreInfProductsCompartmentEditPart.VISUAL_ID),
