...
import org.spbu.pldoctoolkit.graph.diagram.fproduct.edit.policies.InfElementItemSemanticEditPolicy;
...
public class InfElementEditPart extends ShapeNodeEditPart {
	...
	public class InfElementFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureInfElementNameFigure;
		...
		private void createContents() {
			...
			fFigureInfElementNameFigure = new WrapLabel();
			fFigureInfElementNameFigure.setText("<...>");

			this.add(fFigureInfElementNameFigure);
		...
		public WrapLabel getFigureInfElementNameFigure() {
			return fFigureInfElementNameFigure;
		}
