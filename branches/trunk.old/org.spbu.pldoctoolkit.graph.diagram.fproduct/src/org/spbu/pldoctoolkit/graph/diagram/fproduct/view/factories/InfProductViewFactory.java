package org.spbu.pldoctoolkit.graph.diagram.fproduct.view.factories;
 ...
 * @generated
 */
public class InfProductViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (!FinalInfProductEditPart.MODEL_ID.equals(DrlModelVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", FinalInfProductEditPart.MODEL_ID); //$NON-NLS-1$
