 ...
 * @generated
 */
public class FinalInfProductCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = DrlModelDiagramUpdater
				.getFinalInfProduct_79SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		if (!FinalInfProductEditPart.MODEL_ID.equals(DrlModelVisualIDRegistry
				.getModelID(view))) {
			return Collections.EMPTY_LIST;
		}
		...
		case FinalInfProductEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DrlModelDiagramUpdater
						.getFinalInfProduct_79ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case InfProductEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DrlModelDiagramUpdater
						.getInfProduct_1001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case InfElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DrlModelDiagramUpdater
						.getInfElement_1002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case InfElemRefEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(DrlModelDiagramUpdater
						.getInfElemRef_3001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
