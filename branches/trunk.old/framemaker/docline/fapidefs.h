 ...
 */
#define FDK_LIBRARY_VERSION  0x07020000
...
#define FS_NumOpenParams       		FS_DisallowXml 
#define FS_PDFPageNum				44
...
#define FS_ModDateChanged				21 /* Enum Default FV_DoCancel. Also allowable:
											* FV_DoShowDialog, FV_DoOK
											*/
#define FS_NumSaveParams				20	/* Note that 15 is now skipped since it's obsolete */
...
#define FA_Note_Num			106	 /* last notify + 1
									 * Don't forget to add
...
#define FO_Last_Internal      (FO_First_Internal+13) /* ! Internal use only */ 
...
#define FP_ViewQuickAccessBar	  95   /* R/W Boolean */
#define FP_ViewFormattingBar	  96   /* R/W Boolean */
