...
public class ExtractInsertBeforeAction extends Action implements IValidateDRLSelection {
	IEditorPart editor;
	TextEditor te;
	IProject project;
	...
	public final static String refactName = "Extract Insert-Before"; 
	
	public ExtractInsertBeforeAction(IEditorPart editor) throws Exception {
		super(refactName);
		this.editor = editor;
	...
	public void validateSelection(IEditorPart part) {		
		...
		try {
			...
			refact.reset();
			refact.setValidationPararams( DRLdoc, pos1, pos2, ExtractInsertAfterBefore.BEFORE);			
