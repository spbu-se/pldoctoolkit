...
public class ExtractInsertAfterAction extends Action implements IValidateDRLSelection {
	IEditorPart editor;
	TextEditor te;
	IProject project;
	...
	public final static String refactName = "Extract Insert-After"; 
	
	public ExtractInsertAfterAction(IEditorPart editor) throws Exception {
		super(refactName);
		this.editor = editor;
