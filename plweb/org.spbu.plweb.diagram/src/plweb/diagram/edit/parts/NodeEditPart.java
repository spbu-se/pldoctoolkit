...
import plweb.diagram.edit.policies.NodeCanonicalEditPolicy;
import plweb.diagram.edit.policies.NodeItemSemanticEditPolicy;
 ...
 * @generated NOT
 */
public class NodeEditPart extends TargetRefElementEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NodeTitleEditPart) {
			((NodeTitleEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureNodeTitleFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PlwebVisualIDRegistry
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof plweb.diagram.edit.parts.NodeEditPart) {
			types.add(PlwebElementTypes.SourceRefElementClass_4001);
		}
		return types;
	}
	...
	public class NodeFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureNodeTitleFigure;
		...
		private void createContents() {
			...
			fFigureNodeTitleFigure = new WrappingLabel();
			fFigureNodeTitleFigure.setText("<...>");

			this.add(fFigureNodeTitleFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureNodeTitleFigure() {
			return fFigureNodeTitleFigure;
		}
