...
public class DrlModelNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), DocumentationCoreEditPart.MODEL_ID), file,
					false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case DocumentationCoreEditPart.VISUAL_ID: {
			...
			DrlModelNavigatorGroup links = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_DocumentationCore_79_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), InfElementEditPart.VISUAL_ID);
			...
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					InfElemRefGroupEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
		...
		case InfElementEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DrlModelNavigatorGroup outgoinglinks = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_InfElement_1001_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DrlModelNavigatorGroup incominglinks = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_InfElement_1001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view), InfElemRefEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
			connectedViews = getOutgoingLinksByType(
					Collections.singleton(view), InfElemRefEditPart.VISUAL_ID);
			...
			connectedViews = getIncomingLinksByType(
					Collections.singleton(view), InfElemRef2EditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
		...
		case InfProductEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DrlModelNavigatorGroup outgoinglinks = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_InfProduct_1002_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
		...
		case InfElemRefGroupEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DrlModelNavigatorGroup outgoinglinks = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_InfElemRefGroup_1003_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DrlModelNavigatorGroup incominglinks = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_InfElemRefGroup_1003_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getIncomingLinksByType(Collections
					.singleton(view),
					GenericDocumentPartGroupsEditPart.VISUAL_ID);
		...
		case InfElemRefEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DrlModelNavigatorGroup source = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_InfElemRef_3001_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DrlModelNavigatorGroup target = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_InfElemRef_3001_target,
		...
		case GenericDocumentPartGroupsEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DrlModelNavigatorGroup source = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_GenericDocumentPartGroups_3002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DrlModelNavigatorGroup target = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_GenericDocumentPartGroups_3002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), InfElemRefGroupEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
					true));
			connectedViews = getLinksSourceByType(Collections.singleton(view),
					InfElementEditPart.VISUAL_ID);
		...
		case InfElemRef2EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			DrlModelNavigatorGroup source = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_InfElemRef_3003_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			DrlModelNavigatorGroup target = new DrlModelNavigatorGroup(
					Messages.NavigatorGroupName_InfElemRef_3003_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), InfElementEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
