 ...
 * @generated
 */
public class WebmlElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public WebmlElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.WebmlElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "webml".equals(fileExtension); //$NON-NLS-1$
	}
