...
public class InsertIntoDictionaryAction extends Action implements IValidateDRLSelection {
	...
	InsertIntoDictionary refact = new InsertIntoDictionary();
	ProjectContent projectContent;// = new ProjectContent();
	FileEditorInput editorInput;
	
	public final static String refactName = "Insert into Dictionary"; 
	
	public InsertIntoDictionaryAction(IEditorPart editor) throws Exception {
		super(refactName);
		this.editor = editor;
