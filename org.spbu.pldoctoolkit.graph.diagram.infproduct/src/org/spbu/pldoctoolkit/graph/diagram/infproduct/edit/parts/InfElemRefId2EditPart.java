 ...
 * @generated
 */
public class InfElemRefId2EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(DrlModelVisualIDRegistry
				.getType(InfElemRefId2EditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public InfElemRefId2EditPart(View view) {
		super(view);
	}
