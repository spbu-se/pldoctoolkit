 ...
 * @generated
 */
public class DrlModelValidationProvider extends
	...
	public static class ValidateAction extends Action {
		...
		public static void runValidation(View view) {
			try {
				if (DrlModelDiagramEditorUtil.openDiagram(view.eResource())) {
		...
		private static void validate(DiagramEditPart diagramEditPart,
			...
			IFile diagramFile = (target.eResource() != null) ? WorkspaceSynchronizer
					...
					: null;
			if (diagramFile != null) {
				DrlModelMarkerNavigationProvider.deleteMarkers(diagramFile);
			}
			Diagnostic diagnostic = runEMFValidator(target);
			if (diagramFile != null) {
				DrlModelMarkerNavigationProvider.createMarkers(diagramFile,
