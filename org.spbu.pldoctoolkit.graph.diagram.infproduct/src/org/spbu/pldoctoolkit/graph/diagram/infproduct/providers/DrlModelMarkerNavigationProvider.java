 ...
 * @generated
 */
public class DrlModelMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {
	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = DrlModelDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			DrlModelDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
	...
	public static void createMarkers(IFile diagramFile,
		...
		DrlModelDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new DrlModelDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet(), allStatuses));

		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = DrlModelDiagramEditorUtil.findView(diagramEditPart,
