		...
		Platform.getAdapterManager().registerAdapters(
				new IAdapterFactory() {
					...
					public Object getAdapter(Object adaptableObject,
							Class adapterType) {
						if (adaptableObject instanceof org.spbu.pldoctoolkit.graph.diagram.infproduct.navigator.DrlModelNavigatorItem
								&& (adapterType == View.class || adapterType == EObject.class)) {
							return ((org.spbu.pldoctoolkit.graph.diagram.infproduct.navigator.DrlModelNavigatorItem) adaptableObject)
									.getView();
						}
						return null;
					}
	...
	public boolean equals(Object obj) {
		if (obj instanceof org.spbu.pldoctoolkit.graph.diagram.infproduct.navigator.DrlModelNavigatorItem) {
			return EcoreUtil
					...
					.equals(
							EcoreUtil
									.getURI(((org.spbu.pldoctoolkit.graph.diagram.infproduct.navigator.DrlModelNavigatorItem) obj)
											.getView()));
		}
