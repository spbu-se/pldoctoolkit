...
public class InsertIntoDirectoryDialog extends Dialog{
	private Combo directoriesList;
	private List tamplatesList;
	private List entrysList;
	
	private Text selectedTextBox;
	
	ProjectContent projectContent;
	
	public InsertIntoDirectoryDialog(Shell parentShell, ProjectContent projectContent) {
		super(parentShell);
