...
import org.spbu.pldoctoolkit.graph.diagram.productline.edit.policies.PLSchemeCanonicalEditPolicy;
import org.spbu.pldoctoolkit.graph.diagram.productline.edit.policies.PLSchemeGraphicalNodeEditPolicy;
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == DrlModelElementTypes.Product_2002) {
