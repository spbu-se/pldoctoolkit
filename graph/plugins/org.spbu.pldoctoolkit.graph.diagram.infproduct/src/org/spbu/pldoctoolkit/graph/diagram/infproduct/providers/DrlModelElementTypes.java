...
public class DrlModelElementTypes {
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(InfElemRefGroup_3003, DrlPackage.eINSTANCE
					.getInfElemRef_Group());
		}
	 ...
	 * @generated
	 */
	public static final IElementType InfElemRefGroup_3003 = getElementType("org.spbu.pldoctoolkit.graph.diagram.infproduct.InfElemRefGroup_3003"); //$NON-NLS-1$
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(InfElemRefGroup_3003);
		}
